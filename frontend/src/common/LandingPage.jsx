...
// import Footer from '../components/common/Footer'; // Assuming Footer exists
        ...
        <div className="min-h-screen bg-slate-900 text-white font-sans selection:bg-teal-500 selection:text-white overflow-x-hidden">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-teal-200 via-white to-teal-200 drop-shadow-lg">
                    ...
                    >
                        {user ? (
                            <Link
                                to="/dashboard"
                                className="px-8 py-4 bg-teal-600 hover:bg-teal-500 text-white rounded-full font-semibold text-lg transition-all shadow-[0_0_20px_rgba(13,148,136,0.5)] hover:shadow-[0_0_30px_rgba(13,148,136,0.7)] backdrop-blur-sm"
                            >
                                Go to Dashboard
                            </Link>
                            ...
                            <>
                                ...
                                <Link
                                    to="/services"
                                    className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white border border-white/30 rounded-full font-semibold text-lg transition-all backdrop-blur-md"
                                >
                                    Explore Services
                                </Link>
                            </>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className="bg-slate-800/50 backdrop-blur-xl border border-white/10 p-8 rounded-2xl hover:bg-slate-700/50 transition-colors group"
                        >
            ...
            <section className="py-24 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-white/5">
                <div className="max-w-4xl mx-auto text-center px-4">
                    ...
                    {!user && <Link to="/register" className="inline-block px-10 py-4 bg-white text-slate-900 rounded-full font-bold text-lg hover:bg-gray-100 transition-transform hover:scale-105 shadow-xl">
                        Create Free Account
                    </Link>}
                </div>
            </section>
